<template>
  ...
  >
    ...
    />
    <div aria-hidden class="bg-radial to-background absolute inset-0 from-transparent to-75%" />
    <div
      class="dark:bg-background absolute inset-0 m-auto flex size-12 items-center justify-center border-l border-t"
    >
      <slot />
    </div>
  </div>
